...
export const [count,setCount]=createSignal(1);export const [result,setResult]=createSignal(0);createEffect(on([count],()=>setResult(n=>n+1)));export function press(){setCount(2);}
