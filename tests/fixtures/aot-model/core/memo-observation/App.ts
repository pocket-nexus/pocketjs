...
export const [count,setCount]=createSignal(0); export const [result,setResult]=createSignal(0); export const double=createMemo(()=>count()*2); export function press(){setCount(1);setResult(double());}
