...
export const [count,setCount]=createSignal(0); export const items=createMemo(()=>[count()>0?0:0]); export const [result,setResult]=createSignal(0);createEffect(on([items],()=>setResult(r=>r+1),{defer:true}));export function press(){setCount(1);}
