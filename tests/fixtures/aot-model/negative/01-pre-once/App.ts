...
export const [count,setCount]=createSignal(0); export const [result,setResult]=createSignal(0);
createEffect(on([count],()=>setResult(r=>r+1),{defer:true}));
export function press(){setCount(1);setCount(2);}
