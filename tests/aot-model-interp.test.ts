...
type ExprInput<T = ModelExpr> = T extends ModelExpr ? Omit<T, "type" | "loc" | "ledger"> : never;
const e = (x: ExprInput, type: ModelExpr["type"] = I): ModelExpr => ({ ...x, type, loc, ledger });
const lit = (value: any) => e({ kind: "literal", value }, typeof value === "boolean" ? B : typeof value === "string" ? S : I);
const read = (id: number, kind: "local" | "signal" | "memo" | "field" = "signal", type: any = I) => e({ kind, id }, type);
