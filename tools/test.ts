...
const SUITE: readonly Stage[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      "tests/resource-pack-view.test.ts",
  ...
  {
    name: "Manga companion and offline reader",
    tests: [
      "tests/manga-archive.test.ts",
      "tests/manga-cache.test.ts",
      "tests/manga-camera.test.ts",
      "tests/manga-state.test.ts",
      "tests/manga-client.test.ts",
      "tests/manga-document.test.ts",
      "tests/manga-guest.test.ts",
      "tests/manga-pack.test.ts",
      "tests/manga-protocol.test.ts",
      "tests/manga-relay.test.ts",
    ],
  },
  {
